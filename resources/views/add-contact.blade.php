            ...
            <div class="row">
                <div class="col-lg-6 align-items-center mx-auto my-auto">
                    ...
                    <form role="form" action="/create-contact" method="post">
                        ...
                        <!-- Form Step 1 -->
                        <fieldset>
                            <h4>New Contact : <span>Step 1 - 1</span></h4>

                            <div class="row mb-2" >
                                <div class="col">
                                    <label>Name</label>
                                    <input type="text" name="name" class="form-control required" placeholder="Contact Name">
                                </div>
                                <div class="col">
                                    <label>Email</label>
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input type="text" id="contact_address_1" name="contact_address_1" placeholder="Address Line 1" class="form-control">
                                </div>
                                <div class="col">
                                    <label>Contact Address Line 2</label>
                                    <input type="text" id="contact_address_2" name="contact_address_2" placeholder="Address Line 2" class="form-control">
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input type="text" id="contact_postcode" name="contact_postcode" placeholder="Postcode" class="form-control">
                                </div>
                                <div class="col">
                                    <label>Contact Address City</label>
                                    <input type="text" id="contact_city" name="contact_city" placeholder="City" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col">
                                    ...
                                    <input type="text" id="contact_state" name="contact_state" placeholder="State" class="form-control">
                                </div>
                                <div class="col">
